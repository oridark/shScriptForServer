...
class Client:
    ...
    def api_call(self, epoint, **kwargs):
        ...
        elif epoint == "playlist/getFeatured":
            params = {
                "type": "editor-picks",
                "offset": kwargs["offset"],
                "limit": kwargs["limit"],
    ...
    def get_album_list(self, limit, offset):
        return self.api_call("album/getFeatured", limit=limit, offset=offset)
    
    def get_qobuz_playlist(self, limit, offset):
        return self.api_call("playlist/getFeatured", limit=limit, offset=offset)

    def get_plist_albums(self, id):
        return self.api_call("playlist/get", id=id,offset=0)
    ...
    def search_albums(self, query, limit, offset):
        return self.api_call("album/search", query=query, limit=limit, offset=offset)
    ...
    def search_tracks(self, query, offset, limit):
        return self.api_call("track/search", query=query, limit=limit, offset=offset)
